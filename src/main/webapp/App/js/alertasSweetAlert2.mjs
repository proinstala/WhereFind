 ...
 */
const mostrarMensaje = (titulo = "titulo", contenido = "contenido", icon = "success", callback) => {
    Swal.fire({
        title: titulo,
 ...
 * @param {function} callback - Una función de retorno que se ejecuta cuando se confirma el mensaje.
 */
const mostrarMensajeAdvertencia = (titulo = "titulo", contenido = "contenido", icon = "warning", callback) => {
    Swal.fire({
        title: titulo,
        html: `<span class="swal-contenido">${contenido}</span>`,
        icon: icon,
 ...
 * @param {function} callback - Una función de retorno que se ejecuta cuando se confirma el mensaje.
 */
const mostrarMensajeError = (titulo = "titulo", contenido = "contenido", icon = "error", callback) => {
    Swal.fire({
        title: titulo,
        html: `<span class="swal-contenido">${contenido}</span>`,
        icon: icon,
